#include "config.h"
#include "first_strategy_generator.h"
#include "first_strategy.h"

namespace fx {

first_strategy_generator::first_strategy_generator() :
...
void first_strategy_generator::reset()
{
    current_min_candle_ = min_candle_start_;
    current_max_trades_per_candle_ = max_trades_per_candle_start_;
}

strategy_ptr first_strategy_generator::create()
{
    /*struct params
    {
        double volume;
    ...
    return std::make_shared<first_strategy>(par);
}
